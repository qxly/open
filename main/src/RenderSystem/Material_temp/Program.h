...
namespace open
{
	...
	public:
		...
		virtual bool loadFromFile(const char* vs_filePath, const char* ps_filePath, const char* defines = NULL, const char* version = "#version 400");
		
		virtual bool loadProgramFromBuffer(const char* vs, const char* ps, const char* defines = NULL, const char* version = "#version 400");
	...
	private:
		...
		void createProgram(const char* vertShader, const char* frageShader, const char* defines = NULL, const char* version = "#version 400\n");

		uint32 createShader(const char* shaderBuffer, bool vertex, const char* defins = NULL, const char* version = "#version 400\n");
